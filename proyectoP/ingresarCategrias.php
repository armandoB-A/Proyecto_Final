        ...
        <form class="needs-validation" action="pocesar-cat.php" method="post">
            ...
            <div class="form-row">
                <div class="col">
                    ...
                    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="marca" name="txtcat">
                </div>
                <div class="col">
                    <label for="exampleFormControlInput1" class="form-label">descripcion</label>
                    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="descripcion" name="txtdesc">
                </div>
